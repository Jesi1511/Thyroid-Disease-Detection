...
file_handler = logging.FileHandler(os.path.join(main_log_folderpath, model_creation_path))
    ...
    def model_training(self):
        try:
            ...
            with mlflow.start_run():
                ...
                xgboost_pipe = XGBClassifier(max_depth=max_depth, n_estimators=n_estimators, max_leaves=max_leaves, learning_rate=learning_rate)
                ...
                p_scr = precision_score(y_val, y_pred, average='micro', zero_division=1)
                r_scr = recall_score(y_val, y_pred, average='micro', zero_division=1)
                f1_scr = f1_score(y_val, y_pred, average='micro', zero_division=1)
